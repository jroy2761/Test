...
public class CurrentRunPageWriter 
{
	...
	public static int skipedTestCases = 0;
	public static void menuLink(PrintWriter paramPrintWriter, int paramInt)
	  {
	    paramPrintWriter.println("\n            <tr id=\"container\">\n                <td id=\"menu\">\n                    <ul> \n");
	    paramPrintWriter.println(" <li class=\"menuStyle\"><a href=\"../ConsolidatedPage.html\" >Consolidated Page</a></li><li style=\"padding-top: 4px;\">\n");
	    if (paramInt == 1) {
	  ...
	  public static void content(PrintWriter paramPrintWriter, ISuite paramISuite, List<ITestResult> paramList1, List<ITestResult> paramList2, List<ITestResult> paramList3, List<ITestResult> paramList4, List<ITestResult> paramList5, List<ITestResult> paramList6, int paramInt, long paramLong1, long paramLong2)
	  {
	    int i = paramList1.size() + paramList2.size() + paramList3.size();
	    totalTestCases = i;
	    passedTestCases = paramList1.size();
	    failedTestCases = paramList2.size();
	    skipedTestCases = paramList3.size();
	    paramPrintWriter.println("<td id=\"content\">\n                    <div class=\"info\">\n                        The following pie chart demonstrates the percentage of Passed, Failed and Skipped Test Cases<br/>\n                        Time Taken for Executing below Test Cases: <b>" + getExecutionTime(paramLong1, paramLong2) + "</b> <br/>\n" + "                        Current Run Number: <b>Run " + paramInt + "</b>\n" + "                    </div>\n" + "<div class=\"info\">" + "<br/>" + "<b>Run Description</b><br/><br/>" + Reports.currentRunDescription + "</div>" + "                    <div>\n" + "                        <div class=\"chartStyle summary\" style=\"width: 32%;background-color: #3B9C9C;\">\n" + "                            <b>Summary</b><br/><br/>\n" + "                            <table>\n" + "                            <tr>\n" + "                                <td>Execution Date</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Utils.getCurrentTime() + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Total Test Cases</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + i + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Passed</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + paramList1.size() + "</td>\n" + "                            </tr>\n" + "                            \n" + "                            <tr>\n" + "                                <td>Failed</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + paramList2.size() + "</td>\n" + "                            </tr>\n" + "\n" + "                            <tr>\n" + "                                <td>Skipped</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + paramList3.size() + "</td>\n" + "                            </tr>\n" + "                        </table> \n" + "                        </div>" + "                        <div class=\"chartStyle\" style=\"text-align: left;margin-left: 30px;float: left;width: 60%;\">                        \n" + "                            <div id=\"chart\" style=\"height:300px;color:black;\"></div>\n" + "                        </div>\n" + "                    </div>\n" + "                    <div>\n");
	   /* if (Directory.recordSuiteExecution) {
	      paramPrintWriter.println("<p id=\"showmenu\">Click Me to Show/Hide the Execution Video</p><div id=\"video\" class=\"video\"><object classid=\"clsid:9BE31822-FDAD-461B-AD51-BE1D1C159921\" codebase=\"http://downloads.videolan.org/pub/videolan/vlc/latest/win32/axvlc.cab\" width=\"400\" height=\"300\" id=\"vlc\" events=\"True\">  <param name=\"Src\" value=\"ATU_CompleteSuiteRecording.mov\"></param>  <param name=\"ShowDisplay\" value=\"True\" ></param>    <param name=\"AutoLoop\" value=\"no\"></param>    <param name=\"AutoPlay\" value=\"no\"></param>    <embed type=\"application/x-google-vlc-plugin\" name=\"vlcfirefox\" autoplay=\"no\" loop=\"no\" width=\"99%\"  height=\"100%\" target=\"ATU_CompleteSuiteRecording.mov\"></embed> </object></div>");
	    } else {
