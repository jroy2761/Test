...
import selenium_framework.Colors;
import selenium_framework.ExceptionDetails;
	...
	public static void header(PrintWriter paramPrintWriter, ITestResult paramITestResult)
	  ...
	  public static void content(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
	  {
	    ...
	    if (paramITestResult.getStatus() != 3)
	    {
	      ...
	      i = 1;
	      //System.out.println(Reporter.getOutput(paramITestResult));
	    ...
	    if ((paramITestResult.getParameters().length > 0) || (paramITestResult.getStatus() == 3) || (paramITestResult.getStatus() == 2))
	    {
	      ...
	      if (paramITestResult.getParameters().length > 0)
	      {
	        ...
	        for (Object localObject21 : paramITestResult.getParameters()) {
	          paramPrintWriter.print("Param: " + localObject21.toString() + "<br/>");
	        }
	      }
	      if (paramITestResult.getStatus() == 3)
	      {
	        ...
	        if (String.valueOf(localObject1).length() > 0)
	        {
	          str1 = "";
	          for (String str2 : arrayOfString) {//change
	            str1 = str1 + str2 + "<br/>";
	          }
	  ...
	  public static String getSkippedDescription(ITestResult paramITestResult)
	  {
	    ...
	    for (String str3 : arrayOfString2) {
	      object = (String)object + str3;//change
	    }
	    return "";
	  }
	  ...
	  public static void menuLink(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
	  {
	    ...
	    paramPrintWriter.println(" <li class=\"menuStyle\"><a href=\""+ Directory.RESULTSDir + Directory.SEP + "ConsolidatedPage.html\" >Consolidated Page</a></li><li style=\"padding-top: 4px;\">\n");
	    if (paramInt == 1) {
